...
<script type="application/ld+json">
{
  ...
  "liveBlogUpdate":{
    ...
    assert (
        ...
        and metadata.title == "Apple Spring Forward Event Live Blog"
    )
...
<html><body>
    ...
    assert (
        metadata is not None
        and metadata.title == "Mickelson comments hurt new league: Norman"
...
<html><body>
    ...
    assert (
        metadata is not None
        and metadata.title == "12 words and phrases you need to survive in Hamburg"
...
<html><body>
    ...
    assert (
        ...
        and metadata.sitename == "Andreessen Horowitz"
        and metadata.pagetype == "website"
    )
...
<script type="application/ld+json">
{
  "about":{
    ...
    assert (
        metadata is not None
        and metadata.author is None
        and metadata.sitename is None
        and metadata.pagetype is None
    )
    ...
    assert (
        ...
        and metadata.author is None
        and metadata.sitename is None
        and metadata.pagetype == "liveblogposting"
    )
...
<script type="application/ld+json">
{
    ...
    assert (
        metadata is not None
        and metadata.title == "EastEnders' June Brown leaves soap 'for good'"
    ...
    assert (
        ...
        and metadata.title == "How to Tie a Reef Knot"
    ...
    assert (
        metadata is not None
        and metadata.author == "Bill Birtles; John Smith"
        and metadata.pagetype == "newsarticle"
    )
    ...
    assert (
        metadata is not None
        and metadata.title == "Find perfection in these places where land meets water."
